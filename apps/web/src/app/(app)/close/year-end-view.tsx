...
/**
 * Year-end close — roll each entity's temporary accounts into retained earnings.
 * Extracted from the retired /year-end-close standalone page; now the "Year-End" tab of
 * the unified Close screen. Renders its own year selector (no PageHeader; the Close tab
 * shell owns the page title).
 */
export function YearEndCloseView() {
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm text-slate-400 max-w-2xl">
          Roll each entity&apos;s temporary accounts (revenue, COGS, expenses) into retained earnings at fiscal year-end.
        </p>
