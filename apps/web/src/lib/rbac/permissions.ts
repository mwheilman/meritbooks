...
export const FEATURE_CATALOG: FeatureDefinition[] = [
  ...
  { id: 'payments', name: 'Payments / money movement', category: 'Finance & reporting', actions: ['view', 'run'], internalOnly: true },
  { id: 'payments_execute', name: 'Money movement — record payment', category: 'Finance & reporting', actions: ['view', 'run'], internalOnly: true },
  { id: 'check_run', name: 'Money movement — check run (queue AP)', category: 'Finance & reporting', actions: ['view', 'run'], internalOnly: true },
  { id: 'ap_disbursement_release', name: 'Money movement — release AP batch', category: 'Finance & reporting', actions: ['view', 'run'], internalOnly: true },
  { id: 'payroll_release', name: 'Money movement — release payroll run', category: 'Finance & reporting', actions: ['view', 'run'], internalOnly: true },
...
export const ROLE_DEFINITIONS: Record<UserRole, RoleDefinition> = {
  ...
  cfo: {
    ...
    features: buildFeatureMap({
      ...
      intercompany: 'view',
      payments: 'all',
      payments_execute: 'all',
      check_run: 'all',
      ap_disbursement_release: 'all',
      payroll_release: 'all',
      cash_position: 'view',
      forecast: 'all',
      team: 'view',
